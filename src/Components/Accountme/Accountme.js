...
accountType:null,
    ...
    return (
      <div className={classes.container}>
        <div className={classes.bannerContainer}>
          ...
          <h1 className={classes.name}>{this.state.accountName}</h1>
          <p className={classes.AccounType}>{this.state.accountType} account</p>
        </div>
  ...
  componentDidMount() {
    ...
    Axios.get(this.props.ip + "/api/users//" +this.props.meid).then(
      (response) => { this.setState({
        accountType:response.data.info.type,
    ...
    console.log(this.props.ip + "/api/users/" +this.props.meid);
      ...
      (response) => {
        if (this.state.accountType === "company") {
          ...
          this.setState({
            ...
            accountName:response.data.info.name,
            posts:response.data.posts,
            cart:response.data.cart,
            accountType:response.data.info.type,
          });
        } else if (this.state.accountType === "member") {
